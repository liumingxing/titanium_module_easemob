...
public class EaseContactAdapter extends ArrayAdapter<EaseUser> implements SectionIndexer{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            if(res == 0)
                convertView = layoutInflater.inflate(RHelper.get("layout.ease_row_contact"), null);
            else
                convertView = layoutInflater.inflate(res, null);
            holder.avatar = (ImageView) convertView.findViewById(RHelper.get("id.avatar"));
            holder.nameView = (TextView) convertView.findViewById(RHelper.get("id.name"));
            holder.headerView = (TextView) convertView.findViewById(RHelper.get("id.header"));
    ...
    public Object[] getSections() {
        ...
        list.add(getContext().getString(RHelper.get("string.search_header")));
