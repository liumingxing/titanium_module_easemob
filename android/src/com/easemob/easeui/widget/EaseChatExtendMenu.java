...
public class EaseChatExtendMenu extends GridView{
    ...
    class ChatMenuItem extends LinearLayout {
        ...
        private void init(Context context, AttributeSet attrs) {
            ...
            try{
            LayoutInflater.from(context).inflate(TiRHelper.getApplicationResource("layout.ease_chat_menu_item"), this);
            imageView = (ImageView) findViewById(TiRHelper.getApplicationResource("id.image"));
            textView = (TextView) findViewById(TiRHelper.getApplicationResource("id.text"));
            }
            catch(Exception e){
			}
        }
