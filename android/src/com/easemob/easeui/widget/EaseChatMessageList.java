...
public class EaseChatMessageList extends RelativeLayout{
    ...
    private void init(Context context){
        ...
        try{
        LayoutInflater.from(context).inflate(TiRHelper.getApplicationResource("layout.ease_chat_message_list"), this);
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(TiRHelper.getApplicationResource("id.chat_swipe_layout"));
        listView = (ListView) findViewById(TiRHelper.getApplicationResource("id.list"));
        }
        catch(Exception e){
		}
    }
