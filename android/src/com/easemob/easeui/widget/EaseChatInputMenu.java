...
public class EaseChatInputMenu extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try{
	        layoutInflater.inflate(TiRHelper.getApplicationResource("layout.ease_widget_chat_input_menu"), this);	
	        primaryMenuContainer = (FrameLayout) findViewById(TiRHelper.getApplicationResource("id.primary_menu_container"));
	        emojiconMenuContainer = (FrameLayout) findViewById(TiRHelper.getApplicationResource("id.emojicon_menu_container"));
	        chatExtendMenuContainer = (FrameLayout) findViewById(TiRHelper.getApplicationResource("id.extend_menu_container"));
	
	         // 扩展按钮栏
	         chatExtendMenu = (EaseChatExtendMenu) findViewById(TiRHelper.getApplicationResource("id.extend_menu"));
        }
        catch(Exception e){
		}
    ...
    public void init() {
        ...
        if(chatPrimaryMenu == null){
            try{
            chatPrimaryMenu = (EaseChatPrimaryMenu) layoutInflater.inflate(TiRHelper.getApplicationResource("layout.ease_layout_chat_primary_menu"), null);
            }
            catch(Exception e){
            }
        }
        ...
        if(emojiconMenu == null){
        	try{
            	emojiconMenu = (EaseEmojiconMenu) layoutInflater.inflate(TiRHelper.getApplicationResource("layout.ease_layout_emojicon_menu"), null);
            }
            catch(Exception e){
            }
        }
    ...
    protected void processChatMenu() {
        ...
        chatPrimaryMenu.setChatPrimaryMenuListener(new EaseChatPrimaryMenuListener() {
            ...
            Log.d("FFFFFFFFFFFFFFFFFFFFFFFFFF", "toggle extend clicked");
                toggleMore();
            }
