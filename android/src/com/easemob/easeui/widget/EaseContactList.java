...
public class EaseContactList extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try{
        LayoutInflater.from(context).inflate(TiRHelper.getApplicationResource("layout.ease_widget_contact_list"), this);
        listView = (ListView)findViewById(TiRHelper.getApplicationResource("id.list"));
        sidebar = (EaseSidebar) findViewById(TiRHelper.getApplicationResource("id.sidebar"));
        }
        catch(Exception e){
		}
        if(!showSiderBar)
