...
public class EaseSidebar extends View{
	...
	private void init(){
	    String st = context.getString(RHelper.get("string.search_new"));
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:{
			if(header == null){
				try{
					header = (TextView) ((View)getParent()).findViewById(TiRHelper.getApplicationResource("id.floating_header"));
				}
				catch(Exception e){
				}
			}
			...
			setBackgroundResource(RHelper.get("drawable.ease_sidebar_background_pressed"));
			return true;
		}
