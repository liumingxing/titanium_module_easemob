...
public class EaseChatRowLocation extends EaseChatRow{
    ...
    protected void onInflatView() {
        ...
        inflater.inflate(message.direct == EMMessage.Direct.RECEIVE ?
                TiRHelper.getApplicationResource("layout.ease_row_received_location") : TiRHelper.getApplicationResource("layout.ease_row_sent_location"), this);
                }
                catch(Exception e){
                }
    }
    ...
    protected void onFindViewById() {
    	try{
    	locationView = (TextView) findViewById(TiRHelper.getApplicationResource("id.tv_location"));
    	}
    	catch(Exception e){
    	}
    }
