...
public class EaseChatRowImage extends EaseChatRowFile{
    ...
    protected void onInflatView() {
    	try{
        inflater.inflate(message.direct == EMMessage.Direct.RECEIVE ? TiRHelper.getApplicationResource("layout.ease_row_received_picture") : TiRHelper.getApplicationResource("layout.ease_row_sent_picture"), this);
        }
        catch(Exception e){
        }
    }
    ...
    protected void onFindViewById() {
        ...
        imageView = (ImageView) findViewById(TiRHelper.getApplicationResource("id.image"));
        }
        catch(Exception e){
        }
    }
