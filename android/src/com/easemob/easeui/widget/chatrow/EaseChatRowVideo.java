...
public class EaseChatRowVideo extends EaseChatRowFile{
	...
	protected void onInflatView() {
		...
		inflater.inflate(message.direct == EMMessage.Direct.RECEIVE ?
				TiRHelper.getApplicationResource("layout.ease_row_received_video") : TiRHelper.getApplicationResource("layout.ease_row_sent_video"), this);
		}
		catch(Exception e){
		}
	}
	...
	protected void onFindViewById() {
		try{
	    imageView = ((ImageView) findViewById(TiRHelper.getApplicationResource("id.chatting_content_iv")));
        sizeView = (TextView) findViewById(TiRHelper.getApplicationResource("id.chatting_size_iv"));
        timeLengthView = (TextView) findViewById(TiRHelper.getApplicationResource("id.chatting_length_iv"));
        playView = (ImageView) findViewById(TiRHelper.getApplicationResource("id.chatting_status_btn"));
        percentageView = (TextView) findViewById(TiRHelper.getApplicationResource("id.percentage"));
        }
        catch(Exception e){
        }
	}
...
//        playView.setImageResource(R.drawable.video_play_btn_small_nor);
        ...
        if (message.direct == EMMessage.Direct.RECEIVE) {
            ...
            if (message.status == EMMessage.Status.INPROGRESS) {
                imageView.setImageResource(RHelper.get("drawable.ease_default_image"));
