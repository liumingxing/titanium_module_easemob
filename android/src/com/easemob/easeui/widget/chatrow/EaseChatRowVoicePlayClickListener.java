...
public class EaseChatRowVoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		if (message.direct == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(RHelper.get("drawable.ease_chatfrom_voice_playing"));
		} else {
			voiceIconView.setImageResource(RHelper.get("drawable.ease_chatto_voice_playing"));
		}
		// stop play voice
		if (mediaPlayer != null) {
			mediaPlayer.stop();
	...
	private void showAnimation() {
		...
		if (message.direct == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(RHelper.get("anim.voice_from_icon"));
		} else {
			voiceIconView.setImageResource(RHelper.get("anim.voice_to_icon"));
		}
	...
	public void onClick(View v) {
		String st = activity.getResources().getString(RHelper.get("string.Is_download_voice_click_later"));
		if (isPlaying) {
