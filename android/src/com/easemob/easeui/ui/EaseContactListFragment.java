...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    	try{
        return inflater.inflate(TiRHelper.getApplicationResource("layout.ease_fragment_contact_list"), container, false);
        }
        catch(Exception e){
        	return null;
        }
    ...
    protected void initView() {
    	try{
        contentContainer = (FrameLayout) getView().findViewById(TiRHelper.getApplicationResource("id.content_container"));
        
        contactListLayout = (EaseContactList) getView().findViewById(TiRHelper.getApplicationResource("id.contact_list"));        
        listView = contactListLayout.getListView();
        
        //搜索框
        query = (EditText) getView().findViewById(TiRHelper.getApplicationResource("id.query"));
        clearSearch = (ImageButton) getView().findViewById(TiRHelper.getApplicationResource("id.search_clear"));
        }
        catch(Exception e){
		}
    }
...
//                    itemClickLaunchIntent.putExtra(EaseConstant.USER_ID, username);
    ...
    protected void moveToBlacklist(final String username){
        ...
        String st1 = getResources().getString(RHelper.get("string.Is_moved_into_blacklist"));
        final String st2 = getResources().getString(RHelper.get("string.Move_into_blacklist_success"));
        final String st3 = getResources().getString(RHelper.get("string.Move_into_blacklist_failure"));
        pd.setMessage(st1);
