...
public class EaseShowBigImageActivity extends EaseBaseActivity {
	...
	private int default_res = RHelper.get("drawable.ease_default_image");
	...
	protected void onCreate(Bundle savedInstanceState) {
		setContentView(RHelper.get("layout.ease_activity_show_big_image"));
		super.onCreate(savedInstanceState);
		try{
		image = (EasePhotoView) findViewById(TiRHelper.getApplicationResource("id.image"));
		loadLocalPb = (ProgressBar) findViewById(TiRHelper.getApplicationResource("id.pb_load_local"));
		}
		catch(Exception e){
		}
		default_res = getIntent().getIntExtra("default_image", RHelper.get("drawable.ease_default_avatar"));
	...
	private void downloadImage(final String remoteFilePath, final Map<String, String> headers) {
		String str1 = getResources().getString(RHelper.get("string.Download_the_pictures"));
		...
		final EMCallBack callback = new EMCallBack() {
			...
			public void onProgress(final int progress, String status) {
				...
				final String str2 = getResources().getString(RHelper.get("string.Download_the_pictures_new"));
				runOnUiThread(new Runnable() {
					@Override
					public void run() {
