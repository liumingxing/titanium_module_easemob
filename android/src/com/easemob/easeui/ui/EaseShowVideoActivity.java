...
public class EaseShowVideoActivity extends EaseBaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(RHelper.get("layout.ease_showvideo_activity"));
		try{
		loadingLayout = (RelativeLayout) findViewById(TiRHelper.getApplicationResource("id.loading_layout"));
		progressBar = (ProgressBar) findViewById(TiRHelper.getApplicationResource("id.progressBar"));
		}
		catch(Exception e){
		}
