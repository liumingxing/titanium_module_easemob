...
public class DemoHelper {
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onInvitationReceived(String groupId, String groupName, String inviter, String reason) {
            ...
            // 被邀请
            String st3 = appContext.getString(RHelper.get("string.Invite_you_to_join_a_group_chat"));
        ...
        public void onApplicationAccept(String groupId, String groupName, String accepter) {
            ...
            String st4 = appContext.getString(RHelper.get("string.Agreed_to_your_group_chat_application"));
            // 加群申请被同意
            EMMessage msg = EMMessage.createReceiveMessage(Type.TXT);
            msg.setChatType(ChatType.GroupChat);
        ...
        eventListener = new EMEventListener() {
            ...
            public void onEvent(EMNotifierEvent event) {
                ...
                { 
                    ...
                    final String str = appContext.getString(RHelper.get("string.receive_the_passthrough"));
