...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageResizer.setLoadingImage(RHelper.get("drawabledrawable.em_empty_photo"));
	...
	public View onCreateView(LayoutInflater inflater,
		...
		try{
		final View v = inflater.inflate(TiRHelper.getApplicationResource("layout.em_image_grid_fragment"),
				container, false);
		final GridView mGridView = (GridView) v.findViewById(RHelper.get("id.gridView"));
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			if (vEntty.size > 1024 * 1024 * 10) {
				String st = getResources().getString(RHelper.get("string.temporary_does_not"));
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 try{
				 convertView=LayoutInflater.from(mContext).inflate(TiRHelper.getApplicationResource("layout.em_choose_griditem"), container,false);
				 holder.imageView=(RecyclingImageView) convertView.findViewById(RHelper.get("id.imageView"));
				 holder.icon=(ImageView) convertView.findViewById(RHelper.get("id.video_icon"));
				 holder.tvDur=(TextView)convertView.findViewById(RHelper.get("id.chatting_length_iv"));
				 holder.tvSize=(TextView)convertView.findViewById(RHelper.get("id.chatting_size_iv"));
			...
			String st1 = getResources().getString(RHelper.get("string.Video_footage"));
			if(position==0)
			{
				holder.icon.setVisibility(View.GONE);
				holder.tvDur.setVisibility(View.GONE);
				holder.tvSize.setText(st1);
				holder.imageView.setImageResource(RHelper.get("drawabledrawable.em_actionbar_camera_icon"));
			}else{
				...
				holder.imageView.setImageResource(RHelper.get("drawabledrawable.em_empty_photo"));
