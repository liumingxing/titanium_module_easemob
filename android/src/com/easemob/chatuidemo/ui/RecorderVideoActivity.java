...
public class RecorderVideoActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(RHelper.get("layout.em_recorder_activity"));
	...
	private void initViews() {
		btn_switch = (Button) findViewById(RHelper.get("id.switch_btn"));
		btn_switch.setOnClickListener(this);
		btn_switch.setVisibility(View.VISIBLE);
		mVideoView = (VideoView) findViewById(RHelper.get("id.mVideoView"));
		btnStart = (ImageView) findViewById(RHelper.get("id.recorder_start"));
		btnStop = (ImageView) findViewById(RHelper.get("id.recorder_stop"));
...
//		}
	...
	public void onClick(View view) {
		if  (view.getId() == RHelper.get("id.switch_btn"))
			switchCamera();
		else if (view.getId() ==  RHelper.get("id.recorder_start")){
			// start recording
		    if(!startRecording())
		        return;
			Toast.makeText(this, RHelper.get("string.The_video_to_start"), Toast.LENGTH_SHORT).show();
		...
		else if (view.getId() ==  RHelper.get("id.recorder_stop")){
			...
			new AlertDialog.Builder(this)
					.setMessage(RHelper.get("string.Whether_to_send"))
					.setPositiveButton(RHelper.get("string.ok"),
					...
					.setNegativeButton(RHelper.get("string.cancel"),
							new DialogInterface.OnClickListener() {
	...
	public void onInfo(MediaRecorder mr, int what, int extra) {
		...
		if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
			...
			String st3 = getResources().getString(RHelper.get("string.Whether_to_send"));
			new AlertDialog.Builder(this)
					.setMessage(st3)
					.setPositiveButton(RHelper.get("string.ok"),
							new DialogInterface.OnClickListener() {
							...
							}).setNegativeButton(RHelper.get("string.cancel"), null)
					.setCancelable(false).show();
		}
	...
	private void showFailDialog() {
		new AlertDialog.Builder(this)
				.setTitle(RHelper.get("string.prompt"))
				.setMessage(RHelper.get("string.Open_the_equipment_failure"))
				.setPositiveButton(RHelper.get("string.ok"),
						new DialogInterface.OnClickListener() {
