...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentListener{
    ...
    protected void registerExtendMenuItem() {
        ...
        //增加扩展item
        inputMenu.registerExtendMenuItem(RHelper.get("string.attach_video"), RHelper.get("drawable.em_chat_video_selector"), ITEM_VIDEO, extendMenuItemClickListener);
        inputMenu.registerExtendMenuItem(RHelper.get("string.attach_file"), RHelper.get("drawable.em_chat_file_selector"), ITEM_FILE, extendMenuItemClickListener);
        if(chatType == Constant.CHATTYPE_SINGLE){
            inputMenu.registerExtendMenuItem(RHelper.get("string.attach_voice_call"), RHelper.get("drawable.em_chat_voice_call_selector"), ITEM_VOICE_CALL, extendMenuItemClickListener);
            inputMenu.registerExtendMenuItem(RHelper.get("string.attach_video_call"), RHelper.get("drawable.em_chat_video_call_selector"), ITEM_VIDEO_CALL, extendMenuItemClickListener);
        }
    }
    ...
    protected void startVoiceCall() {
        if (!EMChatManager.getInstance().isConnected()) {
            Toast.makeText(getActivity(), RHelper.get("string.not_connect_to_server"), 0).show();
        } else {
