...
public class PickContactNoCheckboxActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(RHelper.get("layout.em_activity_pick_contact_no_checkbox"));
		listView = (ListView) findViewById(RHelper.get("id.list"));
		sidebar = (EaseSidebar) findViewById(RHelper.get("id.sidebar"));
		sidebar.setListView(listView);
		contactList = new ArrayList<EaseUser>();
		// 获取设置contactlist
		getContactList();
		// 设置adapter
		contactAdapter = new EaseContactAdapter(this, RHelper.get("layout.ease_row_contact"), contactList);
