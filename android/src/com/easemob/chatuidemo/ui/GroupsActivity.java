...
public class GroupsActivity extends BaseActivity {
	...
	Handler handler = new Handler(){
	    public void handleMessage(android.os.Message msg) {
            ...
            case 0:
                ...
                break;
            case 1:
                Toast.makeText(GroupsActivity.this, RHelper.get("string.Failed_to_get_group_chat_information"), Toast.LENGTH_LONG).show();
                break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(RHelper.get("layout.em_fragment_groups"));

		instance = this;
		inputMethodManager = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
		grouplist = EMGroupManager.getInstance().getAllGroups();
		groupListView = (ListView) findViewById(RHelper.get("id.list"));
		//show group list
